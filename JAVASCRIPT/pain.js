...
const sliderContainer = document.getElementById("pain-container");

const painProducts = products.filter(
    product => product.category === "gabapentin" || product.category === "painosoma" || product.category === "pain"
);

loadProducts(painProducts);
