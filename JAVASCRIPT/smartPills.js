...
const sliderContainer = document.getElementById("smartPills-container");

const smartPillsProducts = products.filter(
    product => product.category === "armodafinil" || product.category === "modafinil"
);

loadProducts(smartPillsProducts);
